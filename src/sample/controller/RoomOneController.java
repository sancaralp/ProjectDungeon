...
public class RoomOneController extends UserInterface {
    @FXML
    ...
    void Combat(){
        ...
        Combat combat1=new Combat();final String[] CombatText = {"You have encountered a(n) "
    ...
    void EnterRoomTwo(){
        RollButton.getScene().getWindow().hide();
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/sample/view/LevelUp.fxml"));
        try{
            loader.load();
        }
        catch (IOException e) {
